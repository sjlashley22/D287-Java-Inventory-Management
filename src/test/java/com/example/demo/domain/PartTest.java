...
class PartTest {
    ...
    @Test
    void getMinAndSetMin() {
        int minValue = 2;
        partIn.setMin(minValue);
        assertEquals(minValue, partIn.getMin());

        partOut.setMin(minValue);
        assertEquals(minValue, partOut.getMin());
    }

    @Test
    void getMaxAndSetMax() {
        int maxValue = 10;
        partIn.setMax(maxValue);
        assertEquals(maxValue, partIn.getMax());

        partOut.setMax(maxValue);
        assertEquals(maxValue, partOut.getMax());
    }
}